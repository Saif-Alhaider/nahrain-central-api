...
/**
 * Implementation of the EmailValidator interface to validate email addresses specifically for the
 * Nahrain University domain.
 *
 * <p>This class validates email addresses ensuring they conform to the Nahrain University email
 * structure. Valid emails can belong to domains such as "nahrainuniv.edu" or "nahrainuniv.edu.iq".
 *
